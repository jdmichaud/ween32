...
undo of Attributes, of Stretch/Skew or of a drag of the page's corner puts
the old pixels into a picture that is still the new shape. And an undo throws
away whatever is floating: move a selection on the machine and press Ctrl+Z,
