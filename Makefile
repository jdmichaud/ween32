...
OBJS = src/surface.o src/classic.o src/font.o src/marlett.o src/fonts.o src/propsheet.o \
       src/file.o src/shellart.o src/cursorart.o src/gdi.o src/draw.o src/comdlg.o src/menu.o src/imagelist.o src/user.o src/dialog.o src/registry.o src/resource.o src/resource_none.o src/controls.o src/headless.o src/x11.o
...
TESTS = tests/render_test tests/api_test tests/dlg_test tests/input_test \
        ...
        tests/edit_test tests/registry_test
