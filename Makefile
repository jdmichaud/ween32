...
OBJS = src/surface.o src/classic.o src/font.o src/marlett.o src/fonts.o src/propsheet.o \
       src/file.o src/shellart.o src/gdi.o src/draw.o src/comdlg.o src/menu.o src/imagelist.o src/user.o src/dialog.o src/controls.o src/headless.o src/x11.o
